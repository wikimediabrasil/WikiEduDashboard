...
class CoursesController < ApplicationController
  ...
  def wikidata_labels
    set_course
    lookup = WikidataLabelService.new(@course.wikidata_labels)
  ...
  def add_wikidata_label
    ...
    metadata = verified_wikidata_metadata(q_number)
    return if performed?
  ...
  def verified_wikidata_metadata(q_number)
    lookup = WikidataLabelService.new([q_number])
